...
partition_directory = '/Users/kylimckay-bishop/Temporary/CantileverBeam-1/pca_model_results/pca_model_qoi_max_stress/persistence-22/crystalID.csv'
qois_directory = '/Users/kylimckay-bishop/Temporary/CantileverBeam-1/processed_data/Cantilever Beam I_QoIs.csv'

partitions = np.genfromtxt(partition_directory, delimiter=',').reshape(1, -1)
qois_df = pd.read_csv(qois_directory)

crystal_0_directory = '/Users/kylimckay-bishop/Temporary/CantileverBeam-1/pca_model_results/pca_model_qoi_max_stress/persistence-22/crystal-0/'
