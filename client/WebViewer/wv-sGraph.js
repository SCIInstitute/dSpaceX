...
wv["editGPrim"] = function(ctx, name, stripe, gType, vType, data)
{
  ...
  if ((graphic.GPtype == 0) || (graphic.GPtype == 10)) {
    ...
    if (vType == 0) {
      ...
      if (graphic.GPtype == 0) {
        ...
        graphic.points[stripe].nVerts = data.length/2;
      }
  ...
  } else if ((graphic.GPtype == 1) || (graphic.GPtype == 11)) {
    ...
    if (vType == 0) {
      ...
      if (graphic.GPtype == 1) {
        ...
        graphic.lines[stripe].nVerts = data.length/2;
      }
    ...
    if (vType == 0) {
      ...
      if (graphic.GPtype == 2) {
        ...
        graphic.triangles[stripe].nVerts = data.length/2;
      }
