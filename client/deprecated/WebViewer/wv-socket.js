...
wv["UpdateScene"] = function(gl, gl2d)
{
  if (wv.messageQ.length == 0) return;
  
  wv.sceneUpd   = 1;
  if (wv.sceneU2D != undefined) wv.sceneU2D = 1;
      ...
      while (start < message.byteLength) {
        ...
        switch (opcode) {
          ...
          case 1:
            ...
            var size     = 4;
            if ((gtype == 1) || (gtype == 11)) size = 14;
            if ((gtype == 2) || (gtype == 12)) size = 17;
          ...
          case 2:
            ...
            if (nameLen == 0) {
              for (var gprim in wv.sceneGraph) {
                if (wv.sceneGraph[gprim].GPtype > 2) {
                  wv.deleteGPrim(gl2d, gprim);
                } else {
              ...
              var name     = wv.convert2string(uint8nam);
              if (wv.sceneGraph[name] != undefined) {
                if (wv.sceneGraph[name].GPtype > 2) {
                  wv.deleteGPrim(gl2d, name);
                } else {
          ...
          case 3:
            ...
            if (gtype <= 2) {
              ...
              wv.newStripe(gl2d, name, stripe, gtype-10, vertices, colors,
                           indices, normals);
            }
            ...
            switch (vtype) {
              case 0:
                ...
                if (gtype <= 2) {
                  ...
                  wv.editGPrim(gl2d, name, stripe, gtype-10, 0, data);
                }
                size *= 4;
                break;
              case 1:
                ...
                if (gtype <= 2) {
                  ...
                  wv.editGPrim(gl2d, name, stripe, gtype-10, 1, data);
                }
                var oldSize = size;
                size *= 2;
              ...
              case 2:
                ...
                if (gtype <= 2) {
                  ...
                  wv.editGPrim(gl2d, name, stripe, gtype-10, 2, data);
                }
              ...
              case 3:
                ...
                if (gtype <= 2) {
                  ...
                  wv.editGPrim(gl2d, name, stripe, gtype-10, 3, data);
                }
                size *= 4;
                break;
            }
          ...
          case 6:
            ...
            if (wv.sceneGraph[name] != undefined) {
              if (wv.sceneGraph[name].GPtype <= 2) {
                ...
                wv.deleteStripe(gl2d, name, stripe, gtype);
              }
            }
