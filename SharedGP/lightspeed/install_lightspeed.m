...
elseif ismac
    ...
    options.COMPILER = '/usr/bin/xcrun -sdk macosx10.12 clang';
    options.COMPFLAGS = '-fno-common -arch x86_64 -mmacosx-version-min=10.9 -fexceptions -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -DTARGET_API_VERSION=700  -DUSE_MEX_CMD   -DMATLAB_MEX_FILE';
